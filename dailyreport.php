  ...
  background-color: #f5f5f5;
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <!-- form start -->
                <div class="boxx"><br>
                <form class="form-horizontal" method="post" id="addform" action="dailyreport.php">
                    <div class="box-body">
                        <div class="row">
                ...
                <script>
                    function printClick()
                    {
                        ...
                        var tdate=$('#tdate').val();
                        // alert(fdate);
                        window.location.href = "item_bill.php?fdate=" + fdate + "&tdate=" + tdate;
                    }
                </script>
                <!-- Table -->
                                        ...
                                        if (mysqli_num_rows($result) > 0) 
                                        {
                                                    ...
                                                    while($row1 = mysqli_fetch_assoc($result1)) 
                                                    {
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo number_format(round($tota),2); ?></td>
                                                            </tr>
                                                        <?php
                                                        $i++;
                                            ...
                                            <tfoot>
                                                ...
                                                <tr style="background-color:pink;">
                                                    ...
                                                    <td></td>
                                                    <td><b><?php echo number_format(round($totamt),2); ?></b></td>
                                                </tr>
                                        </tfoot>
