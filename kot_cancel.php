<?php include("dbcon.php");
    ...
    $sql="UPDATE `temtable` SET `status`='1',`kot_num`='$kotnumber' WHERE `tabno`='$tab' AND `status`='0'";
    ...
    $sql1 = "INSERT INTO kot_history (date,itmnam,qty,tabno,capname,kot_num) SELECT `date`,`itmnam`,`qty`,`tabno`,`capname`,`kot_num` FROM `kot` HAVING tabno='$tab'";
