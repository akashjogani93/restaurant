    ...
    color: black;
      ...
      tbody{
        ...
        <?php require_once("header.php"); 
            ...
            if(isset($_GET['tabno'],$_GET['print']))
            {
                $current_date = date('Y-m-d');
                $tab1=$_GET['tabno'];
                $print=$_GET['print'];
                $sql="SELECT * FROM `temtable` WHERE `kot_num`='$print' AND `tabno`='$tab1' AND `date`='$current_date'";
