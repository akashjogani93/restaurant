...
<body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <tr v-for="(item, index) in kitchenstock_all" :key="item.id">
                                    ...
                                    <td>
                                        <div style="display:flex;">
                                            <input type="text" name="inputTag" class="form-control" placeholder="Return Qty" style="width: 40%; margin-right:10px;" oninput="validateInput(this)">
    ...
    <script>
        ...
        function validateInput(input)
        {
            ...
            var remain = row.querySelector('.td-class').innerText;

            tdValue = parseFloat(remain);
        ...
        function getDataFromRow(button) 
        {
            ...
            let log=$.ajax({
                ...
                data: {         
                    ...
                    remain_k: rowData[5],   
                    unit_k: rowData[3],
                    inputValue_k: inputValue
                },
                success: function(response) 
                {
                    if(response==0)
                    {
                        alert('Stock Added Back To Store');
                        location.reload();
                    }else
                    {
